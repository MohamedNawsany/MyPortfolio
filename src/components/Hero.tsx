      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <motion.div variants={containerVariants} initial="hidden" animate="visible">
          ...
          >
            ...
            <motion.div className="w-32 h-32 relative flex-shrink-0">
              <div className="w-full h-full rounded-full overflow-hidden shadow-2xl relative border-4 border-white/20">
                <img src={ChatGPT} alt="Mohamed Ahmed EL-Nawsany" className="w-full h-full object-cover" />
                <motion.div
          ...
          <motion.p variants={itemVariants} className="text-lg text-blue-200/80 mb-8 max-w-2xl mx-auto">
            Passionate about creating innovative solutions and building scalable applications with 2+ years
...
<motion.a
href="%PUBLIC_URL%/Mohamed%20Ahmed%20EL-Nawsany.pdf"
  download
